% This latex thesis example was modified from the University of Mississippi Graduate School Template to align with the standards set forth by the University of Mississippi Sally McDonnell Barksdale Honors College by Chase Rydeen
...
\titlepage{YOUR THESIS OR DISSERTATION TITLE}
{by \\
Your Name}	
{Oxford \\
...
\startappendices
\appendix{Appendix Name} %For each additional appendix, use another \appendix command
\input{Appendix/Appendix} %path to appendix contents
